	...
	public static void main(String[] args)
	{
		...
		*/
		...
		for (i=2; i<=5; i++)
		{
			...
			System.out.print(i + " * 1 =  " + mul);
			System.out.print("      ");
		}
		*/
		/*
		for (int h=0; h<2; h++) // 0 1 --> 두 번 반복 --> 문단 구성
		{
		...
		*/
		...
		/*
		for (int h=0; h<=1; h++) // 0 1 --> 두 번 반복 --> 문단 구성 / check~!!!
		{
			for (int i=1; i<=9; i++) // 웅 --> 곱해지는 수
			{
				for (int j=2; j<=5; j++) // 쑝 --> 단
		...
		*/
		...
		for (int h=0; h<=1; h++) // 문단 구성 --> 0 1 --> 두 번 반복
		{
			...
			{
				for (int j=2; j<=5; j++) // 쑝 --> 단 구성 --> 2 3 4 5 6 7 8 9
		...
		{ 
			...
			{
				for (c=a; c<=(a+3); c++) //a가 2일 때 -> 2 3 4 5
				{                        //    6일 때 -> 6 7 8 9
